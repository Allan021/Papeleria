...
public class CustomUI extends BasicComboBoxUI{
    ...
    private ImageIcon espacio =  new ImageIcon(getClass().getResource("/Images/Dashboard/espacio.png"));
    private Color Beautiful = new Color(51,51,51);
    
    
    private Color colorseleccion = new Color(160, 167, 172);
    private Color colorFondo =new Color(42,59,65);
    private Color flecha = new Color(240,240,240);
